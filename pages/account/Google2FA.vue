    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <button
                ...
                :disabled="auth_user.enable_google2fa == 0 && auth_user.google2fa_secret"
    ...
    export default {
        ...
        methods: {
            async getQrCode(regenerate) {
                const response = await this.axios.post('/account/generate_2fa_code', {regenerate: regenerate});
